package com.my.project.update.activity;
...
import com.my.project.update.bsdiff.DiffUtils;
import com.my.project.update.bsdiff.PatchUtils;
import com.my.project.update.utils.FileUtils;
...
public class UpdateActivity extends AppCompatActivity {
    ...
    private String srcDir = Environment.getExternalStorageDirectory().toString() + "/app-v1.apk";
    private String destDir1 = Environment.getExternalStorageDirectory().toString() + "/app-v2.apk";
    private String destDir2 = Environment.getExternalStorageDirectory().toString() + "/app-v3.apk";
    private String patchDir = Environment.getExternalStorageDirectory().toString() + "/app-update2.patch";
    ...
    public void copy(View view) {
        ...
        new CopyTask().execute(srcDir, "app-v1.apk", destDir1, "app-v2.apk");
    }
