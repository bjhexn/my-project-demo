...
public class EncryptUtils {
    ...
    static {
        System.loadLibrary("encrypt");	//defaultConfig.ndk.moduleName
        ...
        if(null != keyValue && null !=iv) {
            ...
            try {
                ...
                paramSpec =new IvParameterSpec(iv);                   // 使用CBC模式，需要一个向量iv，可增加加密算法的强度
                ecipher = Cipher.getInstance("AES/CBC/PKCS5Padding"); // "算法/模式/补码方式"0102030405060708
